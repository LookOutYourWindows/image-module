...
from .preprocessing import get_transform, get_params
...
class StyleTransformer:
    ...
    def __init__(self,
        ...
        self.trainer = TrainerBase(self.config) # getattr(trainers, config[trainer]) = Trainerbase()
        if checkpoint_file is not None: # load checkpoint state dictionary
